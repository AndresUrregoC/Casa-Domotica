...
public class Persiana extends Activity {
	...
	private Switch perciana;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_persiana);

		perciana = (Switch) findViewById(R.id.persiana);

		perciana.setOnCheckedChangeListener(new OnCheckedChangeListener() {

			@Override
			public void onCheckedChanged(CompoundButton buttonView,
					boolean isChecked) {
				// TODO Auto-generated method stub
				if (perciana.isChecked()) {
