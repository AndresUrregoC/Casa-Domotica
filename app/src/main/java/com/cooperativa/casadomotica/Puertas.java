...
public class Puertas extends Activity {
	...
	private Switch puerta_entrada;
	private Switch puerta_pieza;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		puerta_entrada = (Switch) findViewById(R.id.p_entrada);
		puerta_pieza = (Switch) findViewById(R.id.p_pieza);
		...
		puerta_pieza.setOnCheckedChangeListener(new OnCheckedChangeListener() {

			@Override
			public void onCheckedChanged(CompoundButton buttonView,
					boolean isChecked) {
				// TODO Auto-generated method stub
				if(puerta_pieza.isChecked()){
					sendMessage("o\r");
				}else{
					sendMessage("p\r");
